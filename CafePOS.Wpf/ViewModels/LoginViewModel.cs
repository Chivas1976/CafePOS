...
public class LoginViewModel : ObservableObject
{
    ...
    private readonly List<Benutzer> _benutzer = new()
    {
        ...
        new Benutzer { Anzeigename = "Anna Schmidt", Loginname = "anna",  Passwort = "pass123", Rolle = Rolle.Mitarbeiter },
        new Benutzer { Anzeigename = "Peter Weber",  Loginname = "peter", Passwort = "pass123", Rolle = Rolle.Mitarbeiter },
    };
